...
public class DeviceDesiredCapabilities {
    private static DesiredCapabilities setUpNexus5X(){
    ...
    private static DesiredCapabilities setUpEmulator(){
        DesiredCapabilities caps = new	DesiredCapabilities();
    ...
    public static DesiredCapabilities setUpDevice(){
        return DeviceDesiredCapabilities.setUpEmulator();
    }
}
